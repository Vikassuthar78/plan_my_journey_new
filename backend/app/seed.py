...
def seed():
    ...
    states = [
        ...
        {"name": "Kerala", "state": "Kerala", "description": "God's Own Country — lush backwaters, tea gardens, and tropical beaches.", "image": "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800", "is_active": True, "created_at": datetime.utcnow()},
        {"name": "Himachal Pradesh", "state": "Himachal Pradesh", "description": "The abode of snow — stunning Himalayan valleys, ancient temples, and adventure sports.", "image": "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=800", "is_active": True, "created_at": datetime.utcnow()},
        {"name": "Karnataka", "state": "Karnataka", "description": "From the tech hub of Bangalore to the ruins of Hampi — a land of contrasts.", "image": "https://images.unsplash.com/photo-1600100397608-de0a0e395fba?w=800", "is_active": True, "created_at": datetime.utcnow()},
